      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-12">
          ...
          <p className="text-lg text-gray-600 max-w-3xl mx-auto">
            Bạn có câu hỏi hoặc cần hỗ trợ? Hãy liên hệ với chúng tôi và chúng tôi sẽ phản hồi trong thời gian sớm nhất.
          </p>
        </div>
            ...
            <div className="space-y-6">
              <div className="flex items-start">
                ...
                <div className="ml-3 text-base text-gray-700">
                  ...
                  <p>123 Đường Trường Chinh, Quận Thanh Xuân, Hà Nội</p>
                </div>
              </div>
              ...
              <div className="grid grid-cols-1 gap-y-6 sm:grid-cols-2 sm:gap-x-6">
                ...
                <div className="sm:col-span-2">
                  <button
                    type="submit"
                    disabled={loading}
                    className={`w-full inline-flex items-center justify-center py-3 px-6 border border-transparent rounded-md shadow-sm text-base font-medium text-white bg-blue-600 hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 ${
